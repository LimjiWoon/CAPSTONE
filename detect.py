...
def run(
    ...
    def save_cropped_images(source, save_dir, im0, detections, resize_dims=(512, 512)):
        ...
        # detections는 [xmin, ymin, xmax, ymax, confidence, class] 형태의 텐서
        for i, det in enumerate(detections):
            xmin, ymin, xmax, ymax, conf, cls = det
            xmin, ymin, xmax, ymax = int(xmin), int(ymin), int(xmax), int(ymax)  # 픽셀 좌표로 변환
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                save_cropped_images(p, save_dir, im0, det)  # Function call added here
